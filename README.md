...
> 学习网站：[romanrose.github.io/llm_learn](https://romanrose.github.io/llm_learn/)

目前网站已收录 Stanford CS336 2026 的完整课程学习路径，以及 Stanford CS149 Fall 2025 的课程资料与讲次目录。课程页集中提供官方资料、延伸阅读、课程笔记、Blog 解读与中英文逐字稿；未完成或未审核的内容不会公开。
